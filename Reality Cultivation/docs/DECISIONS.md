...
Ngày 2026-09-10: hoàn thành V2.19 tại [[K5_26_V2_19_NHIEU_HO_VA_HOAN_CANH_SINH]]. Snapshot client nay có H01 ven suối, H02 giữ đồng và H03 quán trọ chợ; cả ba qua cùng validator phòng/người chăm/sữa/quyền. `BirthSiteCandidate` hiện người chăm, kỹ năng và bốn kho sau lịch sử, rồi suy cảnh báo từ lượng thật. Runner sinh thử P00 ở cả ba nhánh và xác nhận hộ/phòng/người chăm cùng hash nguồn gốc khác nhau. Trang Hộ theo `worldEntry.householdId`, không còn khóa H01. Ngưỡng cảnh báo và hai hộ mới là fixture chưa duyệt; chưa có huyết thống hay bộ sinh hộ. Hash `491d7f5e50d4d551`; 23 hash cũ giữ nguyên.

Ngày 2026-09-10: hoàn thành V2.18 tại [[K5_25_V2_18_HAU_QUA_LICH_SU_VAO_SNAPSHOT]]. Kết quả đất canh tác, giao thương, áp lực tài nguyên và lũ nay sinh `HistoricalLegacyState` có provenance, hệ số phần nghìn và lượng trước/sau của từng kho. Seed mặc định đổi lương thực 15.000→16.695 g, nước 48.000→47.568 ml, củi 4.500→4.248 g; sữa giữ 10.000 ml và mỗi chuyến tiếp tế tăng lên 110,3%. Hệ thống thử các lượng mới bằng validator nơi sinh trước khi ghi và từ chối seed/kho làm mất nơi sinh cuối cùng. Các hệ số/công thức là fixture kỹ thuật chưa duyệt làm cân bằng. Hash `e777dfadd87c172a`; 22 hash cũ giữ nguyên.
