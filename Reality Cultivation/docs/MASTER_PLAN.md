...
Phần chức năng V0 của K5.1 đã có time/event/command/query/save, shell Flutter responsive, persistence UI, autosave/restore lifecycle và web release. K5.2 đã cho Dart và PWA chạy cùng shared fixture/expected hash; ADR PROPOSED dùng S2 làm working stack, chưa ACCEPTED. [[K5_3_V1_THANG_DAU_SO_SINH]] đã triển khai V1 ngày 0–30 với nhu cầu, giác quan và ý định theo tuổi. [[K5_4_V1_1_CHUOI_CHAM_SOC_NHAN_QUA]] đã nối tiếng khóc qua nhận thức NPC, ngắt việc, di chuyển và vật phẩm thật. [[K5_5_V1_2_CO_THE_SINH_LY_SO_SINH]] đã thêm sinh lý theo giờ, bú–nuốt, dạ dày, ngủ, nhiệt, bài tiết và tăng trưởng để đóng V1 tối thiểu. [[K5_6_V2_0_HO_GIA_DINH_TAI_NGUYEN_QUYEN_LICH]] đã thêm hộ bốn người, kho hữu hạn, quyền vận hành, bữa ăn nguyên tử và sổ chăm sóc–lao động 30 ngày. Theo ưu tiên GUI của người dùng, [[K5_7_GUI_TEXT_GAME_DA_NEN_TANG]] đã tổ chức toàn bộ chức năng thật thành năm khu vực thích nghi cho điện thoại/máy tính. [[K5_8_V2_1_BENH_NHE_TIEP_TE_KHONG_GIAN_DOI_LICH]] đã thêm phòng trong nhà, bệnh nhẹ có diễn tiến, chăm sóc dùng vật chất/quyền, đổi lịch NPC, sản xuất và tiếp tế. [[K5_9_V2_2_VAN_CHUYEN_BENH_SINH_LY_NGUOI_THAY]] đã vật chất hóa chuyến tiếp tế có người chở và giờ đến thật, nối bệnh vào sinh lý theo giờ, cùng cơ chế người chăm sóc thay thế. [[K5_10_V2_3_NHIP_SONG_NPC_VA_HO_SO_THE_GIOI]] đã thêm nhịp sống hằng ngày cho NPC, xung đột lịch có hậu quả thật lên bữa ăn và giờ công, cùng hồ sơ mở cho mọi người và mọi vật kể cả ngoài hộ.

K5.11–K5.28 đã nối tiếp thành chuỗi chạy được: nhu cầu hộ tự sinh việc; ưu tiên phân xử; tay nghề và quyền từ chối; đói, tâm trạng và lên tay; cơ thể, nước và bệnh người lớn; tuyến vận tải hai chiều có ngã rẽ; nghỉ bệnh; [[K5_20_V2_13_GANH_VIEC_KHI_NGHI_BENH|chuyển ca cố định của người nghỉ bệnh]]; [[K5_21_V2_14_BAN_DO_VUNG_DAU_TIEN|bản đồ vùng đầu tiên]]; [[K5_22_V2_15_SINH_BAN_DO_TU_SEED|bộ sinh hình học từ seed]] có provenance lưu được; [[K5_23_V2_16_CHON_NOI_SINH_SAU_KHI_TAO_THE_GIOI|vòng đời chọn nơi sinh]] chỉ tạo P00 sau khi thế giới tồn tại; [[K5_24_V2_17_EPOCH_TIEN_SU_VI_MO|tiền sử vĩ mô]] chạy 300–30.000 năm theo seed qua cohort và anchor; [[K5_25_V2_18_HAU_QUA_LICH_SU_VAO_SNAPSHOT|hậu quả lịch sử]] đổi tồn kho cùng tiếp tế; [[K5_26_V2_19_NHIEU_HO_VA_HOAN_CANH_SINH|ba hộ nhập thế]] tạo ba lựa chọn nguồn lực/người chăm/rủi ro; [[K5_27_V2_20_SINH_HO_VA_QUAN_HE_GIA_DINH|hộ cùng quan hệ gia đình]] sinh xác định từ seed/lịch sử; và [[K5_28_V2_21_HO_NHIEU_THANH_VIEN_VA_LICH_CHAM_TRE|hộ nhiều thành viên]] dùng quan hệ, lịch cùng quyền tài nguyên để chọn người chăm trẻ. Bước tiếp theo đề xuất là thêm nghĩa vụ và ký ức tương tác trong gia đình; shared fixture V1 còn chờ parity PWA.

## 20. Kỷ luật phiên bản từ 2026-09-10

Mục đích V0–V12 ở K4 là ranh giới triển khai, không phải chủ đề mở có thể kéo dài vô hạn. [[LO_TRINH_PHIEN_BAN_VA_DIEU_KIEN_KET_THUC]] ghi cổng kết thúc bắt buộc và là tài liệu phải đọc trước khi đặt số cho lát cắt mới.

V2 “một hộ sống” được đóng về chức năng tại V2.3. Các tên V2.4–V2.21 được giữ vì là lịch sử đã phát hành, nhưng phần bản đồ/worldgen/tiền sử được hiểu là nền viết sớm cho V5/V10. Mã cục bộ chưa phát hành từng gọi V2.22–V2.30 được đổi thành `V3.0-dev.1`–`dev.9`; phần trẻ học kỳ vọng từng gọi V2.31 thành `V4.0-dev.1`.
