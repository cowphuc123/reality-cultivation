...
K5.11–K5.21 đã nối tiếp thành chuỗi chạy được: nhu cầu hộ tự sinh việc; ưu tiên phân xử; tay nghề và quyền từ chối; đói, tâm trạng và lên tay; cơ thể, nước và bệnh người lớn; tuyến vận tải hai chiều có ngã rẽ; nghỉ bệnh; [[K5_20_V2_13_GANH_VIEC_KHI_NGHI_BENH|chuyển ca cố định của người nghỉ bệnh]]; và [[K5_21_V2_14_BAN_DO_VUNG_DAU_TIEN|bản đồ vùng đầu tiên]] quy người, phòng, vật vào địa điểm từ tọa độ thật. Bước tiếp theo đề xuất là sinh vùng và địa điểm xác định từ seed để tiến tới U013; shared fixture V1 còn chờ parity PWA.
