...
K5.11–K5.23 đã nối tiếp thành chuỗi chạy được: nhu cầu hộ tự sinh việc; ưu tiên phân xử; tay nghề và quyền từ chối; đói, tâm trạng và lên tay; cơ thể, nước và bệnh người lớn; tuyến vận tải hai chiều có ngã rẽ; nghỉ bệnh; [[K5_20_V2_13_GANH_VIEC_KHI_NGHI_BENH|chuyển ca cố định của người nghỉ bệnh]]; [[K5_21_V2_14_BAN_DO_VUNG_DAU_TIEN|bản đồ vùng đầu tiên]]; [[K5_22_V2_15_SINH_BAN_DO_TU_SEED|bộ sinh hình học từ seed]] có provenance lưu được; và [[K5_23_V2_16_CHON_NOI_SINH_SAU_KHI_TAO_THE_GIOI|vòng đời chọn nơi sinh]] chỉ tạo P00 sau khi thế giới và điều kiện chăm sóc đã tồn tại. Bước tiếp theo đề xuất là epoch tiền sử tối thiểu chạy không có P00 trước khi mở chọn nơi sinh; shared fixture V1 còn chờ parity PWA.
