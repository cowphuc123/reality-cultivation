...
K5.11–K5.24 đã nối tiếp thành chuỗi chạy được: nhu cầu hộ tự sinh việc; ưu tiên phân xử; tay nghề và quyền từ chối; đói, tâm trạng và lên tay; cơ thể, nước và bệnh người lớn; tuyến vận tải hai chiều có ngã rẽ; nghỉ bệnh; [[K5_20_V2_13_GANH_VIEC_KHI_NGHI_BENH|chuyển ca cố định của người nghỉ bệnh]]; [[K5_21_V2_14_BAN_DO_VUNG_DAU_TIEN|bản đồ vùng đầu tiên]]; [[K5_22_V2_15_SINH_BAN_DO_TU_SEED|bộ sinh hình học từ seed]] có provenance lưu được; [[K5_23_V2_16_CHON_NOI_SINH_SAU_KHI_TAO_THE_GIOI|vòng đời chọn nơi sinh]] chỉ tạo P00 sau khi thế giới tồn tại; và [[K5_24_V2_17_EPOCH_TIEN_SU_VI_MO|tiền sử vĩ mô]] chạy 300–30.000 năm theo seed qua cohort và anchor trước lúc nhập thế. Bước tiếp theo đề xuất là cho hậu quả lịch sử đổi snapshot chơi; shared fixture V1 còn chờ parity PWA.
