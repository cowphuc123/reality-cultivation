...
K5.11–K5.20 đã nối tiếp thành chuỗi chạy được: nhu cầu hộ tự sinh việc; ưu tiên phân xử; tay nghề và quyền từ chối; đói, tâm trạng và lên tay; cơ thể, nước và bệnh người lớn; tuyến vận tải hai chiều có ngã rẽ; nghỉ bệnh; cuối cùng là [[K5_20_V2_13_GANH_VIEC_KHI_NGHI_BENH|chuyển ca cố định của người nghỉ bệnh]] cho thành viên đủ điều kiện. Bước tiếp theo đề xuất là việc nhẹ/nửa buổi khi hồi bệnh hoặc bản đồ vùng; shared fixture V1 còn chờ parity PWA.
